...
import 'package:battaglia_navale/client/client.dart';
          ...
          children: [
            ...
            TextButton(
              onPressed: () async {
                ...
                // int port = int.tryParse(_portController.text) ?? 0; // Se l'input non è un numero valido, impostiamo la porta a 0.
                int port = 3000;
